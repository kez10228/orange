    ...
    >
      <button
        ...
        onClick={() => {
          ...
          window.alert(
            "This is just a joke, I don't have the time to make this feature."
          );
          window.alert(
            "I'll probably make it later (prob not due to procrastination)"
          );
          ...
          window.alert(
            "yet another... FUN FACT: Ctrl + Shift + J opens the console tab"
          );
          setContextMenu({ show: false, x: 0, y: 0 });
        }}
